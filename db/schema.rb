...
ActiveRecord::Schema.define(version: 20161012185854) do
  ...
  add_index "album_photos", ["photo_id", "album_id"], name: "index_album_photos_on_photo_id_and_album_id", unique: true, using: :btree
